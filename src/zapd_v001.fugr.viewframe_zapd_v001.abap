*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAPD_V001
*   generation date: 31.03.2021 at 13:46:52
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAPD_V001           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAPD_V001'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAPD_V001_EXTRACT
TOTAL = ZAPD_V001_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAPD_V001'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAPD_V001-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPD_V001_EXTRACT
TOTAL = ZAPD_V001_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAPD_V001-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAPD_V001'
...
TOTAL = ZAPD_V001_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAPD_V001-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAPD_V001-UPD_FLAG NE SPACE.

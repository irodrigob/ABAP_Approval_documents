*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAPD_V003_2
*   generation date: 23.04.2021 at 09:12:30
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAPD_V003_2         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAPD_V003_2'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAPD_V003_2_EXTRACT
TOTAL = ZAPD_V003_2_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAPD_V003_2'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAPD_V003_2-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPD_V003_2_EXTRACT
TOTAL = ZAPD_V003_2_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAPD_V003_2-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAPD_V003_2'
...
TOTAL = ZAPD_V003_2_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAPD_V003_2-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAPD_V003_2-UPD_FLAG NE SPACE.

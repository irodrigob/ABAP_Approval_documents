*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAPD_V004
*   generation date: 19.04.2021 at 10:59:12
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAPD_V004           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAPD_V004'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAPD_V004_EXTRACT
TOTAL = ZAPD_V004_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAPD_V004'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAPD_V004-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPD_V004_EXTRACT
TOTAL = ZAPD_V004_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAPD_V004-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAPD_V004'
...
TOTAL = ZAPD_V004_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAPD_V004-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAPD_V004-UPD_FLAG NE SPACE.

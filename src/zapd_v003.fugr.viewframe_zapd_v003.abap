*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZAPD_V003
*   generation date: 23.04.2021 at 09:13:41
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZAPD_V003           .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAPD_V003'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAPD_V003_EXTRACT
TOTAL = ZAPD_V003_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAPD_V003'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAPD_V003-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAPD_V003_EXTRACT
TOTAL = ZAPD_V003_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAPD_V003-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAPD_V003'
...
TOTAL = ZAPD_V003_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAPD_V003-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAPD_V003-UPD_FLAG NE SPACE.
